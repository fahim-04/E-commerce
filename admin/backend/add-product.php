                                        ...
                                        <div class="row mb-3">
                                            <div class="form-group col-md-6 mb-3">
                                                ...
                                                <?php if (isset($errors['pro_cate'])): ?>
                                                    <span class="error-message" style="color:red;"><?= $errors['pro_cate'] ?></span>
                                                <?php endif; ?>
                                            </div>
                                            ...
                                            <div class="form-group col-md-6 mb-3">
                                                ...
                                                <input type="text" name="pro_name" class="form-control" id="pro_name"
                                                    value="<?= isset($_POST['pro_name']) ? $_POST['pro_name'] : '' ?>">
                                                <?php if (isset($errors['pro_name'])): ?>
                                                    <span class="error-message"
                                                        style="color:red;"><?= $errors['pro_name'] ?></span>
                                                <?php endif; ?>
                                            </div>
                                            ...
                                            <div class="form-group  col-md-6 mb-3">
                                                ...
                                                <?php if (isset($errors['mrp'])): ?>
                                                    <span class="error-message"
                                                        style="color:red;"><?= $errors['mrp'] ?></span>
                                                <?php endif; ?>
                                            </div>
                                            <div class="form-group  col-md-6 mb-3">
