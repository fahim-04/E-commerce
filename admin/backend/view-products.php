...
$results_per_page = $results_per_page ?? 15;
                            ...
                            <div class="white_card_body pt-5">
                                <div class="QA_section">
                                    ...
                                    <div class="pagination d-flex justify-content-center mt-4">
                                        ...
                                        <?php endfor;
                                        if ($page > 1) {
                                            echo '<a href="?page=' . ($page - 1) . '" class="btn btn-secondary mr-1"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#ffffff" fill="none">
                                        ...
                                        if ($page < $total_pages) {
                                            echo '<a href="?page=' . ($page + 1) . '" class="btn btn-secondary"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#ffffff" fill="none">
